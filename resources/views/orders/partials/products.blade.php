<div class="card-body pb-0">
                    ...
                    <div class="card card-widget widget-user">
                        ...
                        @if($order->isNative())
                            <div class="widget-user-image">
                                <img class="img-circle elevation-2" src="{{ @$item->product->images[0]['medium'] }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4 border-right">
                                    <div class="description-block">
                                        <h5 class="description-header">{{ $item->meta['origin_price'] }}</h5>
                                        <span class="description-text">Origin Price</span>
                                    </div>
                                    <!-- /.description-block -->
                                </div>
                                @endif
    ...
    <hr>
    <div class="row">
        <button data-target="{{ route('orders.cancel.shopper', $order->hash) }}" id="rm-shopper" {{ !$order->isState('pending', 'credit_pending', 'wish_pending', 'wish_callback', 'wish_fail','issue_founded') ? 'disabled' : '' }} class="btn btn-danger">
            Cancel order
        </button>
    </div>
</div>
