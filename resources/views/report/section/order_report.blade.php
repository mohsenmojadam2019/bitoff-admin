                    ...
                    <div class="col-md-3">
                        ...
                        <select class="form-control" name="status">
                            ...
                            @foreach(\App\Models\Order::STATUS as $status)
                                <option
                                    {{ request()->query('status') == $status ? 'selected' : '' }} value="{{ $status }}">{{ $status }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-md-3">
                        ...
                        <select class="form-control" name="currency">
                            <option {{ request()->query('currency') == 'btc' ? 'selected' : '' }} value="btc">btc
                            </option>
                            <option {{ request()->query('currency') == 'usdt' ? 'selected' : '' }} value="usdt">usdt
                            </option>
                        </select>
                    </div>
                </div>
                ...
                <div class="col-md col-sm-6 col-12">
                    <div class="info-box bg-gradient-success">
                        ...
                        <div class="info-box-content">
                            ...
                            <span
                                class="info-box-number">{{request()->query('currency') == 'usdt' ? number_format($totalPriceBeforeOff->dollar).'  usdt' : number_format($totalPriceBeforeOff->btc,8).'  btc' }}   </span>

                            <div class="progress">
                                <div class="progress-bar" style="width: 100%"></div>
                            </div>
                            <span
                                class="progress-description">{{ number_format($totalPriceBeforeOff->dollar) }}  dollar</span>
                        </div>
                    </div>
                </div>
                <div class="col-md col-sm-6 col-12">
                    <div class="info-box bg-gradient-info">
                        ...
                        <div class="info-box-content">
                            ...
                            <span
                                class="info-box-number">{{ request()->query('currency') == 'usdt' ? number_format($totalPriceNextOff->dollar).'  usdt' : number_format($totalPriceNextOff->btc,8).'  btc' }}</span>

                            <div class="progress">
                                <div class="progress-bar" style="width: 100%"></div>
                            </div>
                            <span
                                class="progress-description">{{ number_format($totalPriceNextOff->dollar) }}  dollar</span>
                        </div>
                    </div>
                </div>
                <div class="col-md col-sm-6 col-12">
                    <div class="info-box bg-gradient-warning">
                        ...
                        <div class="info-box-content">
                            ...
                            <span
                                class="info-box-number">{{ request()->query('currency') == 'usdt' ? number_format($wage->dollar).'  usdt' : number_format($wage->btc,8).'  btc' }}</span>

                            <div class="progress">
                                <div class="progress-bar" style="width: 100%"></div>
                            </div>
                            <span class="progress-description">{{ number_format($wage->dollar) }}  dollar</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md col-sm-6 col-12">
                    <div class="info-box bg-gradient-orange">
                        ...
                        <div class="info-box-content">
                            ...
                            <span
                                class="info-box-number">{{ request()->query('currency') == 'usdt' ? number_format($escrow->dollar).'  usdt' : number_format($escrow->btc,8).'  btc' }}</span>

                            <div class="progress">
                                <div class="progress-bar" style="width: 100%"></div>
                            </div>
                            <span class="progress-description">{{ number_format($escrow->dollar) }}  dollar</span>
                        </div>
                    </div>
                </div>
            </div>
